(function () {
    ...
    app.config(function ($routeProvider, $locationProvider) {
        $routeProvider
            .when('/', {
                controller: 'curationListController',
                templateUrl: 'wisdom-talkies/template/curationPageList.html'
            })
            .when('/search/:searchParams', {
                controller: 'curationListController',
                templateUrl: 'wisdom-talkies/template/curationPageList.html'
            })
            .when('/curate/:curateParams', {
                controller: 'curationController',
                templateUrl: 'wisdom-talkies/template/curationBody.html'
            })
            .when('/aboutUs',{
                controller: 'footerController',
                templateUrl: 'wisdom-talkies/template/aboutUs.html'
            })
            .when('/termsOfService', {
                controller: 'footerController',
                templateUrl: 'wisdom-talkies/template/termsOfService.html'
            })
            .when('/privacy', {
                controller: 'footerController',
                templateUrl: 'wisdom-talkies/template/privacy.html'
            })
            .when('/legalNotice', {
                controller: 'footerController',
                templateUrl: 'wisdom-talkies/template/legalNotice.html'
            })
