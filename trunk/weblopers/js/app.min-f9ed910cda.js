...
function handleAccordionIds() {
    var t, e = $(".demo #myAccordion"),
        i = randomNumber(),
        n = "panel-" + i;
    e.attr("id", n),
        e.find(".panel").each(function (e, i) {
            t = "panel-element-" + randomNumber(),
                $(i).find(".panel-title").each(function (e, i) {
                    $(i).attr("data-parent", "#" + n),
                        $(i).attr("href", "#" + t)
                }),
...
function handleCarouselIds() {
    var t = $(".demo #myCarousel"),
        e = randomNumber(),
        i = "carousel-" + e;
    t.attr("id", i),
        t.find(".carousel-indicators li").each(function (t, e) {
            $(e).attr("data-target", "#" + i)
        }),
        t.find(".left").attr("href", "#" + i),
        t.find(".right").attr("href", "#" + i)
}

function handleModalIds() {
    var t = $(".demo #myModalLink"),
        e = randomNumber(),
        i = "modal-container-" + e,
        n = "modal-" + e;
    t.attr("id", n),
...
function handleTabsIds() {
    var t = $(".demo #myTabs"),
        ...
        i = "tabs-" + e;
    t.attr("id", i),
        t.find(".tab-pane").each(function (t, e) {
            var i = $(e).attr("id"),
                n = "panel-" + randomNumber();
            $(e).attr("id", n),
                $(e).parent().parent().find("a[href=#" + i + "]").attr("href", "#" + n)
        })
}
...
function gridSystemGenerator() {
    $(".lyrow .preview input").bind("keyup", function () {
        ...
        $.each(n, function (n, s) {
                i || (parseInt(s) <= 0 && (i = !0),
                    t += parseInt(s),
                    e += '<div class="col-md-' + s + ' column"></div>')
            }),
            12 != t || i ? $(this).parent().prev().hide() : ($(this).parent().next().children().html(e),
...
function removeElm() {
    $(".demo").on("click", ".remove", function (t) {
        t.preventDefault(),
            $(this).parent().remove(), !$(".demo .lyrow").length > 0 && clearDemo()
    })
}
...
function removeMenuClasses() {
    $("#menu-alayout li button").removeClass("active")
}
...
function downloadLayoutSrc() {
    var promptTemplateName  =   window.prompt('Give this template a name');
    ...
    t.find(".preview, .configuration, .drag, .remove").remove(),
        ...
        $("#download-layout .container").length > 0 && changeStructure("row-fluid", "row"),
    ...
    downloadLayout(promptTemplateName);
}
if (! function (t, e) {
        ...
        function l(t, e, i) {
            ...
            if (void 0 === i && 1 === t.nodeType)
                if (n = "data-" + e.replace(_t, "-$1").toLowerCase(),
                    i = t.getAttribute(n),
                    "string" == typeof i) {
                    try {
        ...
        function _(t) {
            var e = Q,
                i = Ft[t];
            return i || (i = y(t, e),
                    "none" !== i && i || (Rt = (Rt || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
                        e = Rt[0].contentDocument,
                        e.write(),
                        e.close(),
                        i = y(t, e),
                        Rt.detach()),
        ...
        function w(t, e, i) {
            ...
            return i = i || qt(t),
                ...
                i && ("" !== a || Z.contains(t.ownerDocument, t) || (a = Z.style(t, e)),
                    Lt.test(a) && jt.test(e) && (n = r.width,
                        s = r.minWidth,
                        o = r.maxWidth,
        ...
        function D(t, e, i, n, s) {
            for (var o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; 4 > o; o += 2)
                "margin" === i && (a += Z.css(t, i + xt[o], !0, s)),
                n ? ("content" === i && (a -= Z.css(t, "padding" + xt[o], !0, s)),
                    "margin" !== i && (a -= Z.css(t, "border" + xt[o] + "Width", !0, s))) : (a += Z.css(t, "padding" + xt[o], !0, s),
                    "padding" !== i && (a += Z.css(t, "border" + xt[o] + "Width", !0, s)));
            return a
        }
        ...
        function T(t, e, i) {
            ...
            if (0 >= s || null == s) {
                if (s = w(t, e, o), (0 > s || null == s) && (s = t.style[e]),
                    Lt.test(s))
                    return s;
                n = a && (G.boxSizingReliable() || s === t.style[e]),
                    s = parseFloat(s) || 0
            }
        ...
        function I(t, e) {
            for (var i, n, s, o = [], a = 0, r = t.length; r > a; a++)
                n = t[a],
                n.style && (o[a] = vt.get(n, "olddisplay"),
                    i = n.style.display,
                    e ? (o[a] || "none" !== i || (n.style.display = ""),
                        "" === n.style.display && Ct(n) && (o[a] = vt.access(n, "olddisplay", _(n.nodeName)))) : (s = Ct(n),
                        "none" === i && s || vt.set(n, "olddisplay", s ? i : Z.css(n, "display"))));
            for (a = 0; r > a; a++)
                n = t[a],
        ...
        function P(t, e, i) {
            ...
            i.queue || (r = Z._queueHooks(t, "fx"),
                    ...
                    u.always(function () {
                        u.always(function () {
                            r.unqueued--,
                                Z.queue(t, "fx").length || r.empty.fire()
                        })
                    })),
                1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [p.overflow, p.overflowX, p.overflowY],
                    h = Z.css(t, "display"),
                    c = "none" === h ? vt.get(t, "olddisplay") || _(t.nodeName) : h,
                    "inline" === c && "none" === Z.css(t, "float") && (p.display = "inline-block")),
        ...
        function H(t, e, i) {
            ...
            for (M(c, h.opts.specialEasing); a > o; o++)
                if (n = ee[o].call(h, t, c, h.opts))
                    return n;
            return Z.map(c, N, h),
                Z.isFunction(h.opts.start) && h.opts.start.call(t, h),
        ...
        function R(t, e, i, n) {
            ...
            for (o = c.shift(); o;)
                if (t.responseFields[o] && (i[t.responseFields[o]] = e), !l && n && t.dataFilter && (e = t.dataFilter(e, t.dataType)),
                    l = o,
                    o = c.shift())
                    if ("*" === o)
                        o = l;
                ...
                for ("boolean" == typeof a && (h = a,
                    ...
                    if (null != (t = arguments[r]))
                        for (e in t)
                            i = a[e],
                            n = t[e],
                            a !== n && (h && n && (Z.isPlainObject(n) || (s = Z.isArray(n))) ? (s ? (s = !1,
                                    o = i && Z.isArray(i) ? i : []) : o = i && Z.isPlainObject(i) ? i : {},
                                a[e] = Z.extend(h, o, n)) : void 0 !== n && (a[e] = n));
                return a
            },
            Z.extend({
                ...
                each: function (t, e, n) {
                    ...
                    if (n) {
                        ...
                        for (; a > o && (s = e.call(t[o], o, t[o]),
                                s !== !1); o++)
                    ;
                    else
                        for (o in t)
                            if (s = e.call(t[o], o, t[o]),
                                s === !1)
                                break;
                    return t
                },
                ...
                makeArray: function (t, e) {
                    var n = e || [];
                    return null != t && (i(Object(t)) ? Z.merge(n, "string" == typeof t ? [t] : t) : Y.call(n, t)),
                        n
                },
                ...
                proxy: function (t, e) {
                    ...
                    return "string" == typeof e && (i = t[e],
                            e = t,
                            t = i),
                        Z.isFunction(t) ? (n = q.call(arguments, 2),
                            s = function () {
                                return t.apply(e || this, n.concat(q.call(arguments)))
                            },
                            s.guid = t.guid = t.guid || Z.guid++,
                            s) : void 0
                },
                now: Date.now,
                support: G
        ...
        var st = function (t) {
            function e(t, e, i, n) {
                ...
                if ((e ? e.ownerDocument || e : F) !== P && N(e),
                    e = e || P,
                    i = i || [],
                    r = e.nodeType,
                ...
                if (!n && H) {
                    ...
                    if (w.qsa && (!O || !O.test(t))) {
                        if (p = u = R,
                            ...
                            for (h = D(t), (u = e.getAttribute("id")) ? p = u.replace(_t, "\\$&") : e.setAttribute("id", p),
                                p = "[id='" + p + "'] ",
                                l = h.length; l--;)
                                h[l] = p + d(h[l]);
            ...
            function b(t) {
                for (var e, i, n, s = t.length, o = x.relative[t[0].type], a = o || x.relative[" "], r = o ? 1 : 0, l = p(function (t) {
                    ...
                    if (i = x.relative[t[r].type])
                        ...
                        if (i = x.filter[t[r].type].apply(null, t[r].matches),
                            i[R]) {
            ...
            var _, w, x, C, k, D, T, I, S, E, A, N, P, M, H, O, $, z, W, R = "sizzle" + 1 * new Date,
                F = t.document,
                j = 0,
                L = 0,
                q = i(),
            ...
            w = e.support = {},
                ...
                N = e.setDocument = function (t) {
                    ...
                    return n !== P && 9 === n.nodeType && n.documentElement ? (P = n,
                        ...
                        O = [], (w.qsa = vt.test(n.querySelectorAll)) && (s(function (t) {
                                M.appendChild(t).innerHTML = "<a id='" + R + "'></a><select id='" + R + "-\f]' msallowcapture=''><option selected=''></option></select>",
                                    t.querySelectorAll("[msallowcapture^='']").length && O.push("[*^$]=" + it + "*(?:''|\"\")"),
                                    t.querySelectorAll("[selected]").length || O.push("\\[" + it + "*(?:value|" + et + ")"),
                                    t.querySelectorAll("[id~=" + R + "-]").length || O.push("~="),
                        ...
                        W = e || vt.test(M.contains) ? function (t, e) {
                        ...
                        U = e ? function (t, e) {
                            ...
                            return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1,
                                1 & i || !w.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === F && W(F, t) ? -1 : e === n || e.ownerDocument === F && W(F, e) ? 1 : E ? tt(E, t) - tt(E, e) : 0 : 4 & i ? -1 : 1)
                        } : function (t, e) {
                            if (t === e)
                                return A = !0,
                                    0;
                ...
                e.matchesSelector = function (t, i) {
                    if ((t.ownerDocument || t) !== P && N(t),
                        i = i.replace(ut, "='$1']"), !(!w.matchesSelector || !H || $ && $.test(i) || O && O.test(i)))
                        try {
                            var n = z.call(t, i);
                ...
                e.contains = function (t, e) {
                    return (t.ownerDocument || t) !== P && N(t),
                        W(t, e)
                },
                e.attr = function (t, e) {
                ...
                x = e.selectors = {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (t) {
                            var e, i = !t[6] && t[2];
                            return ft.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && dt.test(i) && (e = D(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                                    t[2] = i.slice(0, e)),
                                t.slice(0, 3))
                        }
                    },
                    filter: {
                        ...
                        ATTR: function (t, i, n) {
                            return function (s) {
                                var o = e.attr(s, t);
                                return null == o ? "!=" === i : i ? (o += "",
                                    "=" === i ? o === n : "!=" === i ? o !== n : "^=" === i ? n && 0 === o.indexOf(n) : "*=" === i ? n && o.indexOf(n) > -1 : "$=" === i ? n && o.slice(-n.length) === n : "~=" === i ? (" " + o.replace(rt, " ") + " ").indexOf(n) > -1 : "|=" === i ? o === n || o.slice(0, n.length + 1) === n + "-" : !1) : !0
                            }
                        },
                                ...
                                if (g) {
                                    ...
                                    if (f = [a ? g.firstChild : g.lastChild],
                                        ...
                                        for (c = g[R] || (g[R] = {}),
                                            ...
                                            p = h[0] === j && h[1],
                                            d = h[0] === j && h[2],
                                            u = p && g.childNodes[p]; u = ++p && u && u[m] || (d = p = 0) || f.pop();)
                                        ...
                                        for (;
                                            (u = ++p && u && u[m] || (d = p = 0) || f.pop()) && ((r ? u.nodeName.toLowerCase() !== v : 1 !== u.nodeType) || !++d || (b && ((u[R] || (u[R] = {}))[t] = [j, d]),
                                                u !== e));)
                                    ;
                                    return d -= s,
                                        d === n || d % n === 0 && d / n >= 0
            ...
            return u.prototype = x.filters = x.pseudos,
                ...
                D = e.tokenize = function (t, i) {
                    ...
                    for (r = t,
                        l = [],
                        h = x.preFilter; r;) {
                        (!n || (s = ht.exec(r))) && (s && (r = r.slice(s[0].length) || r),
                            l.push(o = [])),
                        n = !1, (s = ct.exec(r)) && (n = s.shift(),
                            o.push({
                                value: n,
                                type: s[0].replace(lt, " ")
                            }),
                            r = r.slice(n.length));
                        for (a in x.filter)
                            !(s = ft[a].exec(r)) || h[a] && !(s = h[a](s)) || (n = s.shift(),
                                o.push({
                                    value: n,
                                    type: a,
                                    matches: s
                ...
                I = e.select = function (t, e, i, n) {
                    ...
                    if (i = i || [],
                        ...
                        if (o = u[0] = u[0].slice(0),
                            o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === e.nodeType && H && x.relative[o[1].type]) {
                    ...
                    return (h || T(t, u))(n, e, !H, i, yt.test(t) && c(e.parentNode) || e),
                        i
                },
        ...
        Z.find = st,
            ...
            Z.unique = st.uniqueSort,
            Z.text = st.getText,
            Z.isXMLDoc = st.isXML,
            Z.contains = st.contains;
        ...
        Z.filter = function (t, e, i) {
                var n = e[0];
                return i && (t = ":not(" + t + ")"),
                    1 === e.length && 1 === n.nodeType ? Z.find.matchesSelector(n, t) ? [n] : [] : Z.find.matches(t, Z.grep(e, function (t) {
                        return 1 === t.nodeType
                    }))
            },
            Z.fn.extend({
                find: function (t) {
                    ...
                    for (e = 0; i > e; e++)
                        Z.find(t, s[e], n);
                    return n = this.pushStack(i > 1 ? Z.unique(n) : n),
                ...
                if ("string" == typeof t) {
                    ...
                    if (i[1]) {
                        if (e = e instanceof Z ? e[0] : e,
                            Z.merge(this, Z.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : Q, !0)),
                            at.test(i[1]) && Z.isPlainObject(e))
                            for (i in e)
                                Z.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                        return this
                    }
                    return n = Q.getElementById(i[2]),
            ...
            Z.each({
                ...
                Z.fn[t] = function (i, n) {
                    ...
                    return "Until" !== t.slice(-5) && (n = i),
                        n && "string" == typeof n && (s = Z.filter(n, s)),
                        this.length > 1 && (dt[t] || Z.unique(s),
                            ut.test(t) && s.reverse()),
                        this.pushStack(s)
                }
            });
            ...
            Z.extend({
                ...
                ready: function (t) {
                    (t === !0 ? --Z.readyWait : Z.isReady) || (Z.isReady = !0,
                        t !== !0 && --Z.readyWait > 0 || (mt.resolveWith(Q, [Z]),
            ...
            r.prototype = {
                ...
                access: function (t, e, i) {
                    ...
                    return void 0 === e || e && "string" == typeof e && void 0 === i ? (n = this.get(t, e),
                        void 0 !== n ? n : this.get(t, Z.camelCase(e))) : (this.set(t, e, i),
                        void 0 !== i ? i : e)
                },
                remove: function (t, e) {
                    ...
                    if (void 0 === e)
                        ...
                        Z.isArray(e) ? n = e.concat(e.map(Z.camelCase)) : (s = Z.camelCase(e),
                                e in a ? n = [e, s] : (n = s,
                                    n = n in a ? [n] : n.match(pt) || [])),
                            i = n.length;
                        for (; i--;)
                            delete a[n[i]]
                    }
            ...
            Z.fn.extend({
                data: function (t, e) {
                    var i, n, s, o = this[0],
                        a = o && o.attributes;
                    if (void 0 === t) {
                        if (this.length && (s = bt.get(o),
                                1 === o.nodeType && !vt.get(o, "hasDataAttrs"))) {
                            for (i = a.length; i--;)
                                a[i] && (n = a[i].name,
                                    0 === n.indexOf("data-") && (n = Z.camelCase(n.slice(5)),
                                        l(o, n, s[n])));
            ...
            Z.extend({
                queue: function (t, e, i) {
                    ...
                    return t ? (e = (e || "fx") + "queue",
                        n = vt.get(t, e),
                        i && (!n || Z.isArray(i) ? n = vt.access(t, e, Z.makeArray(i)) : n.push(i)),
                        n || []) : void 0
                },
            ...
            Z.fn.extend({
                queue: function (t, e) {
                    ...
                    return "string" != typeof t && (e = t,
                            t = "fx",
                            i--),
                        arguments.length < i ? Z.queue(this[0], t) : void 0 === e ? this : this.each(function () {
                            var i = Z.queue(this, t, e);
                            Z._queueHooks(this, t),
                                "fx" === t && "inprogress" !== i[0] && Z.dequeue(this, t)
                        })
                },
                dequeue: function (t) {
                    return this.each(function () {
        ...
        Z.event = {
                ...
                add: function (t, e, i, n, s) {
                    ...
                    if (g)
                        for (i.handler && (o = i,
                                i = o.handler,
                                s = o.selector),
                            i.guid || (i.guid = Z.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function (e) {
                            ...
                            p && (u = Z.event.special[p] || {},
                                ...
                                c = Z.extend({
                                    ...
                                    d.delegateCount = 0,
                                    u.setup && u.setup.call(t, n, f, a) !== !1 || t.addEventListener && t.addEventListener(p, a, !1)),
                    ...
                    if (g && (l = g.events)) {
                        for (e = (e || "").match(pt) || [""],
                            ...
                            if (r = Et.exec(e[h]) || [],
                                ...
                                f = (r[2] || "").split(".").sort(),
                                p) {
                                for (u = Z.event.special[p] || {},
                                    p = (n ? u.delegateType : u.bindType) || p,
                                    d = l[p] || [],
                                    r = r[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                                    a = o = d.length; o--;)
                                    c = d[o], !s && m !== c.origType || i && i.guid !== c.guid || r && !r.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (d.splice(o, 1),
                                        c.selector && d.delegateCount--,
                                        u.remove && u.remove.call(t, c));
                                a && !d.length && (u.teardown && u.teardown.call(t, f, g.handle) !== !1 || Z.removeEvent(t, p, g.handle),
                                    delete l[p])
                            } else
                                for (p in l)
                ...
                trigger: function (e, i, n, s) {
                    var o, a, r, l, h, c, u, d = [n || Q],
                        p = X.call(e, "type") ? e.type : e,
                        f = X.call(e, "namespace") ? e.namespace.split(".") : [];
                    if (a = r = n = n || Q,
                        3 !== n.nodeType && 8 !== n.nodeType && !St.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."),
                                p = f.shift(),
                                f.sort()),
                            h = p.indexOf(":") < 0 && "on" + p,
                            ...
                            e.result = void 0,
                            e.target || (e.target = n),
                            i = null == i ? [e] : Z.makeArray(i, [e]),
                            u = Z.event.special[p] || {},
                            s || !u.trigger || u.trigger.apply(n, i) !== !1)) {
                        if (!s && !u.noBubble && !Z.isWindow(n)) {
                            for (l = u.delegateType || p,
                                St.test(l + p) || (a = a.parentNode); a; a = a.parentNode)
                                d.push(a),
                                r = a;
                            r === (n.ownerDocument || Q) && d.push(r.defaultView || r.parentWindow || t)
                        }
                        for (o = 0;
                            (a = d[o++]) && !e.isPropagationStopped();)
                            e.type = o > 1 ? l : u.bindType || p,
                            c = (vt.get(a, "events") || {})[e.type] && vt.get(a, "handle"),
                            c && c.apply(a, i),
                            c = h && a[h],
                            c && c.apply && Z.acceptData(a) && (e.result = c.apply(a, i),
                                e.result === !1 && e.preventDefault());
                        return e.type = p,
                            s || e.isDefaultPrevented() || u._default && u._default.apply(d.pop(), i) !== !1 || !Z.acceptData(n) || h && Z.isFunction(n[p]) && !Z.isWindow(n) && (r = n[h],
                                r && (n[h] = null),
                                Z.event.triggered = p,
                                n[p](),
                ...
                dispatch: function (t) {
                    ...
                    if (r[0] = t,
                        t.delegateTarget = this, !h.preDispatch || h.preDispatch.call(this, t) !== !1) {
                        for (a = Z.event.handlers.call(this, t, l),
                            e = 0;
                            ...
                            for (t.currentTarget = s.elem,
                                ...
                                (!t.namespace_re || t.namespace_re.test(o.namespace)) && (t.handleObj = o,
                                    t.data = o.data,
                                    n = ((Z.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, r),
                        ...
                        for (; l !== this; l = l.parentNode || this)
                            if (l.disabled !== !0 || "click" !== t.type) {
                                for (n = [],
                                    ...
                                    o = e[i],
                                    s = o.selector + " ",
                                    void 0 === n[s] && (n[s] = o.needsContext ? Z(s, this).index(l) >= 0 : Z.find(s, this, null, [l]).length),
                                    n[s] && n.push(o);
                                n.length && a.push({
                                    elem: l,
                                    handlers: n
                ...
                fix: function (t) {
                    ...
                    var e, i, n, s = t.type,
                        o = t,
                        a = this.fixHooks[s];
                    for (a || (this.fixHooks[s] = a = It.test(s) ? this.mouseHooks : Tt.test(s) ? this.keyHooks : {}),
                ...
                simulate: function (t, e, i, n) {
                    ...
                    n ? Z.event.trigger(s, null, e) : Z.event.dispatch.call(e, s),
                ...
                Z.event.special[t] = {
                    ...
                    handle: function (t) {
                        var i, n = this,
                            s = t.relatedTarget,
                            o = t.handleObj;
                        return (!s || s !== n && !Z.contains(n, s)) && (t.type = o.origType,
            ...
            G.focusinBubbles || Z.each({
                ...
                Z.event.special[e] = {
                    ...
                    teardown: function () {
                        var n = this.ownerDocument || this,
                            s = vt.access(n, e) - 1;
                        s ? vt.access(n, e, s) : (n.removeEventListener(t, i, !0),
                            vt.remove(n, e))
                    }
                }
            }),
                ...
                off: function (t, e, i) {
                    ...
                    if (t && t.preventDefault && t.handleObj)
                        return n = t.handleObj,
                            Z(t.delegateTarget).off(n.namespace ? n.origType + "." + n.namespace : n.origType, n.selector, n.handler),
                            this;
                    if ("object" == typeof t) {
                        for (s in t)
                            this.off(s, e, t[s]);
            ...
            Z.extend({
                ...
                buildFragment: function (t, e, i, n) {
                    for (var s, o, a, r, l, h, c = e.createDocumentFragment(), u = [], d = 0, p = t.length; p > d; d++)
                        ...
                        for (o = o || c.appendChild(e.createElement("div")),
                            a = (Nt.exec(s) || ["", ""])[1].toLowerCase(),
                            r = Wt[a] || Wt._default,
                            o.innerHTML = r[1] + s.replace(At, "<$1></$2>") + r[2],
                            h = r[0]; h--;)
                            o = o.lastChild;
                    ...
                    for (c.textContent = "",
                        d = 0; s = u[d++];)
                        if ((!n || -1 === Z.inArray(s, n)) && (l = Z.contains(s.ownerDocument, s),
                                o = v(c.appendChild(s), "script"),
                                l && m(o),
                                i))
                            for (h = 0; s = o[h++];)
                ...
                cleanData: function (t) {
                    for (var e, i, n, s, o = Z.event.special, a = 0; void 0 !== (i = t[a]); a++) {
                        if (Z.acceptData(i) && (s = i[vt.expando],
                                s && (e = vt.cache[s]))) {
                            if (e.events)
                                for (n in e.events)
            ...
            Z.fn.extend({
                ...
                remove: function (t, e) {
                    for (var i, n = t ? Z.filter(t, this) : this, s = 0; null != (i = n[s]); s++)
                        e || 1 !== i.nodeType || Z.cleanData(v(i)),
                        i.parentNode && (e && Z.contains(i.ownerDocument, i) && m(v(i, "script")),
                ...
                domManip: function (t, e) {
                    ...
                    if (m || h > 1 && "string" == typeof d && !G.checkClone && Ht.test(d))
                        return this.each(function (i) {
                            var n = c.eq(i);
                            m && (t[0] = d.call(this, i, n.html())),
                                n.domManip(t, e)
                        });
                    if (h && (i = Z.buildFragment(t, this[0].ownerDocument, !1, this),
                            n = i.firstChild,
                            1 === i.childNodes.length && (i = n),
                            n)) {
                        for (s = Z.map(v(i, "script"), p),
                            o = s.length; h > l; l++)
                            a = i,
                            l !== u && (a = Z.clone(a, !0, !0),
                                o && Z.merge(s, v(a, "script"))),
                            e.call(this[l], a, l);
                        if (o)
                            for (r = s[s.length - 1].ownerDocument,
                                ...
                                l = 0; o > l; l++)
                                a = s[l],
                                Ot.test(a.type || "") && !vt.access(a, "globalEval") && Z.contains(r, a) && (a.src ? Z._evalUrl && Z._evalUrl(a.src) : Z.globalEval(a.textContent.replace(zt, "")))
                    }
                    return this
                }
            }),
        ...
        Z.extend({
                ...
                style: function (t, e, i, n) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        var s, o, a, r = Z.camelCase(e),
                            l = t.style;
                        return e = Z.cssProps[r] || (Z.cssProps[r] = C(l, r)),
                            a = Z.cssHooks[e] || Z.cssHooks[r],
                            void 0 === i ? a && "get" in a && void 0 !== (s = a.get(t, !1, n)) ? s : l[e] : (o = typeof i,
                                "string" === o && (s = Ut.exec(i)) && (i = (s[1] + 1) * s[2] + parseFloat(Z.css(t, e)),
                                    o = "number"),
                                void(null != i && i === i && ("number" !== o || Z.cssNumber[r] || (i += "px"),
                ...
                css: function (t, e, i, n) {
                    var s, o, a, r = Z.camelCase(e);
                    return e = Z.cssProps[r] || (Z.cssProps[r] = C(t.style, r)),
                        a = Z.cssHooks[e] || Z.cssHooks[r],
                        a && "get" in a && (s = a.get(t, !0, i)),
                        void 0 === s && (s = w(t, e, n)),
                        "normal" === s && e in Vt && (s = Vt[e]),
                        "" === i || i ? (o = parseFloat(s),
                            i === !0 || Z.isNumeric(o) ? o || 0 : s) : s
                }
            }),
            ...
            S.prototype = {
                ...
                run: function (t) {
                    ...
                    return this.pos = e = this.options.duration ? Z.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t,
                        ...
                        i && i.set ? i.set(this) : S.propHooks._default.set(this),
                        this
                }
            },
            ...
            ie = {
                "*": [function (t, e) {
                        var i = this.createTween(t, e),
                            ...
                            a = (Z.cssNumber[t] || "px" !== o && +n) && Zt.exec(Z.css(i.elem, t)),
                            r = 1,
                            l = 20;
                        if (a && a[3] !== o) {
                            o = o || a[3],
        ...
        Z.Animation = Z.extend(H, {
            ...
            Z.speed = function (t, e, i) {
                ...
                return n.duration = Z.fx.off ? 0 : "number" == typeof n.duration ? n.duration : n.duration in Z.fx.speeds ? Z.fx.speeds[n.duration] : Z.fx.speeds._default, (null == n.queue || n.queue === !0) && (n.queue = "fx"),
                    n.old = n.complete,
                    n.complete = function () {
        ...
        Z.fn.extend({
            ...
            Z.extend({
                attr: function (t, e, i) {
                    ...
                    return t && 3 !== o && 8 !== o && 2 !== o ? typeof t.getAttribute === Dt ? Z.prop(t, e, i) : (1 === o && Z.isXMLDoc(t) || (e = e.toLowerCase(),
                            n = Z.attrHooks[e] || (Z.expr.match.bool.test(e) ? se : ne)),
                        void 0 === i ? n && "get" in n && null !== (s = n.get(t, e)) ? s : (s = Z.find.attr(t, e),
                            null == s ? void 0 : s) : null !== i ? n && "set" in n && void 0 !== (s = n.set(t, i, e)) ? s : (t.setAttribute(e, i + ""),
                            i) : void Z.removeAttr(t, e)) : void 0
                },
                removeAttr: function (t, e) {
                    ...
                    if (o && 1 === t.nodeType)
                        for (; i = o[s++];)
                            n = Z.propFix[i] || i,
                            Z.expr.match.bool.test(i) && (t[n] = !1),
                            t.removeAttribute(i)
                },
                attrHooks: {
                    type: {
            ...
            se = {
                set: function (t, e, i) {
                    return e === !1 ? Z.removeAttr(t, i) : t.setAttribute(i, i),
                        i
                }
            },
        ...
        Z.fn.extend({
            ...
            Z.extend({
                ...
                prop: function (t, e, i) {
                    ...
                    return t && 3 !== a && 8 !== a && 2 !== a ? (o = 1 !== a || !Z.isXMLDoc(t),
                        o && (e = Z.propFix[e] || e,
                            s = Z.propHooks[e]),
                        void 0 !== i ? s && "set" in s && void 0 !== (n = s.set(t, i, e)) ? n : t[e] = i : s && "get" in s && null !== (n = s.get(t, e)) ? n : t[e]) : void 0
                },
                propHooks: {
                    tabIndex: {
                        get: function (t) {
            ...
            addClass: function (t) {
                ...
                if (r)
                    for (e = (t || "").match(pt) || []; h > l; l++)
                        if (i = this[l],
                            n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(re, " ") : " ")) {
                            for (o = 0; s = e[o++];)
                                n.indexOf(" " + s + " ") < 0 && (n += s + " ");
                            a = Z.trim(n),
            ...
            toggleClass: function (t, e) {
                ...
                return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : this.each(Z.isFunction(t) ? function (i) {
                    ...
                    if ("string" === i)
                        ...
                        (i === Dt || "boolean" === i) && (this.className && vt.set(this, "__className__", this.className),
        ...
        Z.fn.extend({
                val: function (t) {
                    var e, i, n, s = this[0];
                    return arguments.length ? (n = Z.isFunction(t),
                        this.each(function (i) {
                            var s;
                            1 === this.nodeType && (s = n ? t.call(this, i, Z(this).val()) : t,
                                null == s ? s = "" : "number" == typeof s ? s += "" : Z.isArray(s) && (s = Z.map(s, function (t) {
                                    return null == t ? "" : t + ""
                                })),
                                e = Z.valHooks[this.type] || Z.valHooks[this.nodeName.toLowerCase()],
                                e && "set" in e && void 0 !== e.set(this, s, "value") || (this.value = s))
                        })) : s ? (e = Z.valHooks[s.type] || Z.valHooks[s.nodeName.toLowerCase()],
                ...
                ajax: function (t, e) {
                    function i(t, e, i, a) {
                        ...
                        2 !== y && (y = 2,
                            ...
                            i && (b = W(u, w, i)),
                            b = R(u, b, w, l),
                            l ? (u.ifModified && (_ = w.getResponseHeader("Last-Modified"),
                                    _ && (Z.lastModified[s] = _),
                                    _ = w.getResponseHeader("etag"),
                                    _ && (Z.etag[s] = _)),
                                204 === t || "HEAD" === u.type ? x = "nocontent" : 304 === t ? x = "notmodified" : (x = b.state,
                                    c = b.data,
                                    v = b.error,
                                    l = !v)) : (v = x, (t || !x) && (x = "error",
                                0 > t && (t = 0))),
                            ...
                            m.fireWith(d, [w, x]),
                            h && (p.trigger("ajaxComplete", [w, u]),
                                --Z.active || Z.event.trigger("ajaxStop")))
                    }
                    "object" == typeof t && (e = t,
                            t = void 0),
                        e = e || {};
                    var n, s, o, a, r, l, h, c, u = Z.ajaxSetup({}, e),
                        d = u.context || u,
                    ...
                    if (f.promise(w).complete = m.add,
                        w.success = w.done,
                        w.error = w.fail,
                        u.url = ((t || u.url || we) + "").replace(ue, "").replace(ge, xe[1] + "//"),
                        u.type = e.method || e.type || u.method || u.type,
                        u.dataTypes = Z.trim(u.dataType || "*").toLowerCase().match(pt) || [""],
                        null == u.crossDomain && (l = ve.exec(u.url.toLowerCase()),
                            u.crossDomain = !(!l || l[1] === xe[1] && l[2] === xe[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (xe[3] || ("http:" === xe[1] ? "80" : "443")))),
                    ...
                    h = Z.event && u.global,
                        ...
                        s = u.url,
                        u.hasContent || (u.data && (s = u.url += (ce.test(s) ? "&" : "?") + u.data,
                                delete u.data),
                            u.cache === !1 && (u.url = de.test(s) ? s.replace(de, "$1_=" + he++) : s + (ce.test(s) ? "&" : "?") + "_=" + he++)),
                        u.ifModified && (Z.lastModified[s] && w.setRequestHeader("If-Modified-Since", Z.lastModified[s]),
                            Z.etag[s] && w.setRequestHeader("If-None-Match", Z.etag[s])), (u.data && u.hasContent && u.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", u.contentType),
                        w.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + ("*" !== u.dataTypes[0] ? ", " + _e + "; q=0.01" : "") : u.accepts["*"]);
                    for (c in u.headers)
                        ...
                        e = function (t) {
                                return function () {
                                    e && (delete Ee[a],
                                        ...
                                        "abort" === t ? o.abort() : "error" === t ? n(o.status, o.statusText) : n(Ae[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
                                            text: o.responseText
        ...
        Z.ajaxSetup({
            ...
            Z.ajaxPrefilter("json jsonp", function (e, i, n) {
                ...
                return r || "jsonp" === e.dataTypes[0] ? (s = e.jsonpCallback = Z.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
                    r ? e[r] = e[r].replace(Me, "$1" + s) : e.jsonp !== !1 && (e.url += (ce.test(e.url) ? "&" : "?") + e.jsonp + "=" + s),
                    e.converters["script json"] = function () {
                        return a || Z.error(s + " was not called"),
                            a[0]
                    },
                    e.dataTypes[0] = "json",
                    o = t[s],
            ...
            Z.parseHTML = function (t, e, i) {
                ...
                var n = at.exec(t),
                    s = !i && [];
                return n ? [e.createElement(n[1])] : (n = Z.buildFragment([t], e, s),
                    s && s.length && Z(s).remove(),
        ...
        Z.offset = {
                setOffset: function (t, e, i) {
                    var n, s, o, a, r, l, h, c = Z.css(t, "position"),
                        u = Z(t),
                        d = {};
            ...
            Z.fn.extend({
                offset: function (t) {
                    ...
                    return o ? (e = o.documentElement,
                        Z.contains(e, n) ? (typeof n.getBoundingClientRect !== Dt && (s = n.getBoundingClientRect()),
                            i = j(o), {
            ...
            Z.each(["top", "left"], function (t, e) {
                Z.cssHooks[e] = x(G.pixelPosition, function (t, i) {
                    return i ? (i = w(t, e),
                        Lt.test(i) ? Z(t).position()[e] + "px" : i) : void 0
                })
            }),
            Z.each({
                Height: "height",
                    ...
                    Z.fn[n] = function (n, s) {
                        ...
                        return gt(this, function (e, i, n) {
                            ...
                            return Z.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (s = e.documentElement,
                                Math.max(e.body["scroll" + t], s["scroll" + t], e.body["offset" + t], s["offset" + t], s["client" + t])) : void 0 === n ? Z.css(e, i, a) : Z.style(e, i, n, a)
                        }, e, o ? n : void 0, o, null)
                    }
                })
            }),
        ...
        return Z.noConflict = function (e) {
                return t.$ === Z && (t.$ = ze),
                    e && t.jQuery === Z && (t.jQuery = $e),
                    Z
            },
            typeof e === Dt && (t.jQuery = t.$ = Z),
            Z
    }),
    function (t) {
        ...
        function e(e, n) {
            ...
            return "area" === r ? (s = e.parentNode,
                o = s.name,
                e.href && o && "map" === s.nodeName.toLowerCase() ? (a = t("img[usemap='#" + o + "']")[0], !!a && i(a)) : !1) : (/input|select|textarea|button|object/.test(r) ? !e.disabled : "a" === r ? e.href || n : n) && i(e)
        }
            ...
            t.widget.bridge = function (e, i) {
                ...
                t.fn[e] = function (s) {
                    var o = "string" == typeof s,
                        ...
                        r = this;
                    return s = !o && a.length ? t.widget.extend.apply(null, [s].concat(a)) : s,
        ...
        t(document).mouseup(function () {
            ...
            t.widget("ui.mouse", {
                ...
                _mouseMove: function (e) {
                    return t.ui.ie && (!document.documentMode || 9 > document.documentMode) && !e.button ? this._mouseUp(e) : e.which ? this._mouseStarted ? (this._mouseDrag(e),
                    ...
                    t.fn.position = function (s) {
                        ...
                        return y = n(_),
                            ...
                            t.each(["my", "at"], function () {
                                ...
                                1 === i.length && (i = h.test(i[0]) ? i.concat(["center"]) : c.test(i[0]) ? ["center"].concat(i) : ["center", "center"]),
                            ...
                            this.each(function () {
                                ...
                                "right" === s.my[0] ? I.left -= u : "center" === s.my[0] && (I.left -= u / 2),
                                    "bottom" === s.my[1] ? I.top -= d : "center" === s.my[1] && (I.top -= d / 2),
                                    I.left += S[0],
                                    I.top += S[1],
                                    o || (I.left = l(I.left),
                                        I.top = l(I.top)),
                                    ...
                                    s.using && (h = function (t) {
                                        ...
                                        u > m && m > r(e + i) && (l.horizontal = "center"),
                        ...
                        fit: {
                            left: function (t, e) {
                                ...
                                e.collisionWidth > o ? l > 0 && 0 >= h ? (i = t.left + l + e.collisionWidth - o - s,
                                    t.left += l - i) : t.left = h > 0 && 0 >= l ? s : l > h ? s + o - e.collisionWidth : s : l > 0 ? t.left += l : h > 0 ? t.left -= h : t.left = a(t.left - r, t.left)
                            },
                            top: function (t, e) {
                                var i, n = e.within,
                                ...
                                e.collisionHeight > o ? l > 0 && 0 >= h ? (i = t.top + l + e.collisionHeight - o - s,
                                    t.top += l - i) : t.top = h > 0 && 0 >= l ? s : l > h ? s + o - e.collisionHeight : s : l > 0 ? t.top += l : h > 0 ? t.top -= h : t.top = a(t.top - r, t.top)
                            }
                        },
                        flip: {
                            left: function (t, e) {
                            ...
                            top: function (t, e) {
                                var i, n, s = e.within,
                                    ...
                                    m = -2 * e.offset[1];
                                0 > c ? (n = t.top + p + f + m + e.collisionHeight - a - o,
                                    t.top + p + f + m > c && (0 > n || r(c) > n) && (t.top += p + f + m)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - l,
            ...
            t.widget("ui.accordion", {
                ...
                _eventHandler: function (e) {
                    ...
                    e.preventDefault(),
                        o && !i.collapsible || this._trigger("beforeActivate", e, h) === !1 || (i.active = a ? !1 : this.headers.index(s),
                            this.active = o ? t() : s,
                            this._toggle(h),
                    ...
                    return "number" == typeof c && (o = c),
                        ...
                        e.length ? t.length ? (n = t.show().outerHeight(),
                            ...
                            void t.hide().animate(this.showProps, {
                                ...
                                step: function (t, i) {
                                    i.now = Math.round(t),
                                        "height" !== i.prop ? r += i.now : "content" !== a.options.heightStyle && (i.now = Math.round(n - e.outerHeight() - r),
                                            r = 0)
                                }
                ...
                _keydown: function (e) {
                    ...
                    default:
                        l = !1,
                            ...
                            n.length || (o = String.fromCharCode(e.keyCode),
                                r = RegExp("^" + i(o), "i"),
                                n = this.activeMenu.find(this.options.items).filter(function () {
                                    return r.test(t(this).text())
                                })),
        ...
        var d, p = "ui-button ui-widget ui-state-default ui-corner-all",
            ...
            g = function (e) {
                ...
                return i && (i = i.replace(/'/g, "\\'"),
                        s = n ? t(n).find("[name='" + i + "'][type=radio]") : t("[name='" + i + "'][type=radio]", e.ownerDocument).filter(function () {
                            return !this.form
                        })),
                    s
            };
        ...
        t.extend(s.prototype, {
                ...
                _attachments: function (e, i) {
                    ...
                    i.append && i.append.remove(),
                        ...
                        n = this._get(i, "showOn"), ("focus" === n || "both" === n) && e.focus(this._showDatepicker), ("button" === n || "both" === n) && (s = this._get(i, "buttonText"),
                        ...
                        case 13:
                            return s = t("td." + t.datepicker._dayOverClass + ":not(." + t.datepicker._currentClass + ")", o.dpDiv),
                                ...
                                i ? (n = t.datepicker._formatDate(o),
                                    i.apply(o.input ? o.input[0] : null, [n, o])) : t.datepicker._hideDatepicker(), !1;
                        case 27:
                            t.datepicker._hideDatepicker();
                            break;
                        case 33:
                ...
                _selectDay: function (e, i, n, s) {
                    var o, a = t(e);
                    t(s).hasClass(this._unselectableClass) || this._isDisabledDatepicker(a[0]) || (o = this._getInst(a[0]),
                ...
                parseDate: function (e, i, n) {
                    ...
                    if (-1 === m ? m = (new Date).getFullYear() : 100 > m && (m += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (c >= m ? 0 : -100)),
                        b > -1)
                        for (g = 1,
                            v = b; o = this._getDaysInMonth(m, g - 1), !(o >= v);)
                            g++,
                            v -= o;
                ...
                _generateHTML: function (t) {
                    var e, i, n, s, o, a, r, l, h, c, u, d, p, f, m, g, v, b, y, _, w, x, C, k, D, T, I, S, E, A, N, P, M, H, O, $, z, W, R, F = new Date,
                    ...
                    for (t.drawMonth = Z,
                        ...
                        n = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i + "</span></a>" : B ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i + "</span></a>",
                        s = this._get(t, "nextText"),
                        s = Y ? this.formatDate(s, this._daylightSavingAdjust(new Date(tt, Z + V, 1)), this._getFormatConfig(t)) : s,
                        o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + s + "</span></a>" : B ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + s + "</span></a>",
                        ...
                        h = q ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (L ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (L ? "" : l) + "</div>" : "",
                        ...
                        for (C = "",
                                ...
                                if (I += "<div class='ui-datepicker-group",
                                    ...
                                    case 0:
                                        I += " ui-datepicker-group-first",
                                            T = " ui-corner-" + (L ? "right" : "left");
                                        break;
                                    case U[1] - 1:
                                        I += " ui-datepicker-group-last",
                                            T = " ui-corner-" + (L ? "left" : "right");
                                        break;
                                    default:
                            ...
                            for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === x ? L ? o : n : "") + (/all|right/.test(T) && 0 === x ? L ? n : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || k > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
                                S = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "",
                                w = 0; 7 > w; w++)
                                E = (w + c) % 7,
                                S += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[E] + "'>" + p[E] + "</span></th>";
                            ...
                            Z > 11 && (Z = 0,
                                    tt++),
                                I += "</tbody></table>" + (X ? "</div>" + (U[0] > 0 && k === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""),
                                C += I
                        }
                        _ += C
                    }
                ...
                _adjustInstDate: function (t, e, i) {
                    ...
                    t.selectedDay = a.getDate(),
                        ...
                        t.drawYear = t.selectedYear = a.getFullYear(), ("M" === i || "Y" === i) && this._notifyChange(t)
                },
                ...
                _isInRange: function (t, e) {
                    ...
                    return l && (i = l.split(":"),
                        ...
                        r = parseInt(i[1], 10),
                        i[0].match(/[+\-].*/) && (a += n),
                        i[1].match(/[+\-].*/) && (r += n)), (!s || e.getTime() >= s.getTime()) && (!o || e.getTime() <= o.getTime()) && (!a || e.getFullYear() >= a) && (!r || r >= e.getFullYear())
                },
            ...
            t.widget("ui.draggable", t.ui.mouse, {
                ...
                _mouseCapture: function (e) {
                    ...
                    return this.helper || n.disabled || t(e.target).closest(".ui-resizable-handle").length > 0 ? !1 : (this.handle = this._getHandle(e),
                        this.handle ? (t(n.iframeFix === !0 ? "iframe" : n.iframeFix).each(function () {
            ...
            t.ui.plugin.add("draggable", "snap", {
                ...
                drag: function (e, i, n) {
                    ...
                    for (d = n.snapElements.length - 1; d >= 0; d--)
                        l = n.snapElements[d].left,
                        h = l + n.snapElements[d].width,
                        c = n.snapElements[d].top,
                        u = c + n.snapElements[d].height,
                        l - m > v || g > h + m || c - m > y || b > u + m || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                                snapItem: n.snapElements[d].item
                            })),
                            n.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = m >= Math.abs(c - y),
                                o = m >= Math.abs(u - b),
                                a = m >= Math.abs(l - v),
                                r = m >= Math.abs(h - g),
                            ...
                            p = s || o || a || r,
                            "outer" !== f.snapMode && (s = m >= Math.abs(c - b),
                                o = m >= Math.abs(u - y),
                                a = m >= Math.abs(l - g),
                                r = m >= Math.abs(h - v),
                                s && (i.position.top = n._convertPositionTo("relative", {
                                ...
                                }).left - n.margins.left)), !n.snapElements[d].snapping && (s || o || a || r || p) && n.options.snap.snap && n.options.snap.snap.call(n.element, e, t.extend(n._uiHash(), {
                                snapItem: n.snapElements[d].item
                            })),
                ...
                _mouseDrag: function (e) {
                    ...
                    return this._updatePrevProperties(),
                        l ? (i = l.apply(this, [e, a, r]),
                            this._updateVirtualBoundaries(e.shiftKey), (this._aspectRatio || e.shiftKey) && (i = this._updateRatio(i, e)),
                            i = this._respectSize(i, e),
                            this._updateCache(i),
                            this._propagate("resize", e),
                            n = this._applyChanges(), !this._helper && this._proportionallyResizeElements.length && this._proportionallyResize(),
                    ...
                    n.grid = l,
                        ...
                        /^(se|s|e)$/.test(r) ? (i.size.width = p,
                            ...
                            p - h > 0 ? (i.size.width = p,
                                i.position.left = a.left - u) : (p = c - e.height,
                                i.size.width = p,
                ...
                _setOption: function (t, e) {
                    ...
                    "dialogClass" === t && s.removeClass(this.options.dialogClass).addClass(e),
                        "disabled" !== t && (this._super(t, e),
                            ...
                            "draggable" === t && (i = s.is(":data(ui-draggable)"),
                                i && !e && s.draggable("destroy"), !i && e && this._makeDraggable()),
                            "position" === t && this._position(),
                            "resizable" === t && (n = s.is(":data(ui-resizable)"),
            ...
            t.ui.ddmanager = {
                ...
                drop: function (e, i) {
                    ...
                    return t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), function () {
                            this.options && (!this.options.disabled && this.visible && t.ui.intersect(e, this, this.options.tolerance, i) && (n = this._drop.call(this, i) || n), !this.options.disabled && this.visible && this.accept.call(this.element[0], e.currentItem || e.element) && (this.isout = !0,
                                this.isover = !1,
        ...
        t.effects = {
                    ...
                    h.fn = t.extend(h.prototype, {
                        parse: function (s, a, r, l) {
                            ...
                            var u = this,
                                d = t.type(s),
                                p = this._rgba = [];
                            return a !== e && (s = [s, a, r, l],
                                    d = "array"),
                                "string" === d ? this.parse(n(s) || o._default) : "array" === d ? (f(c.rgba.props, function (t, e) {
                                        p[e.idx] = i(s[e.idx], e)
                                    }),
                            ...
                            f(o, function (e, i) {
                                h.fn[e] || (h.fn[e] = function (s) {
                                    ...
                                    return "undefined" === a ? c : ("function" === a && (s = s.call(this, c),
                                            a = t.type(s)),
                                        null == s && i.empty ? this : ("string" === a && (o = r.exec(s),
                                                o && (s = c + parseFloat(o[2]) * ("+" === o[1] ? 1 : -1))),
                                            h[i.idx] = s,
                                            this[l](h)))
                                })
                            })
            ...
            function () {
                function e(e, i, n, s) {
                    return t.isPlainObject(e) && (i = e,
                        ...
                        t.isFunction(i) && (s = i,
                            n = null,
                            i = {}), ("number" == typeof i || t.fx.speeds[i]) && (s = n,
                            n = i,
                            i = {}),
                        t.isFunction(n) && (s = n,
                            n = null),
                ...
                t.extend(t.effects, {
                        ...
                        createWrapper: function (e) {
                            ...
                            return e.wrap(n), (e[0] === o || t.contains(e[0], o)) && t(o).focus(),
                                n = e.parent(),
            ...
            t.effects.effect.bounce = function (e, i) {
                ...
                for ((c || h) && r.push("opacity"),
                    ...
                    c && (o = {
                        ...
                        o[v] = 0,
                        a.css("opacity", 0).css(v, b ? 2 * -d : 2 * d).animate(o, m, g)),
                    h && (d /= Math.pow(2, p - 1)),
                    o = {},
                    o[v] = 0,
                    n = 0; p > n; n++)
            ...
            t.effects.effect.drop = function (e, i) {
                ...
                t.effects.save(s, o),
                    ...
                    r && s.css("opacity", 0).css(h, "pos" === c ? -n : n),
                    u[h] = (r ? "pos" === c ? "+=" : "-=" : "pos" === c ? "-=" : "+=") + n,
                    s.animate(u, {
                        queue: !1,
                        duration: e.duration,
            ...
            t.effects.effect.size = function (e, i) {
                ...
                "show" === p && a.show(),
                    ...
                    "toggle" === e.mode && "show" === p ? (a.from = e.to || y,
                        a.to = e.from || n) : (a.from = e.from || ("show" === p ? y : n),
                        a.to = e.to || ("hide" === p ? y : n)),
                    o = {
                        from: {
                    ...
                    }, ("box" === m || "both" === m) && (o.from.y !== o.to.y && (b = b.concat(u),
                            a.from = t.effects.setTransition(a, u, o.from.y, a.from),
                            a.to = t.effects.setTransition(a, u, o.to.y, a.to)),
                        o.from.x !== o.to.x && (b = b.concat(d),
                            a.from = t.effects.setTransition(a, d, o.from.x, a.from),
                            a.to = t.effects.setTransition(a, d, o.to.x, a.to))), ("content" === m || "both" === m) && o.from.y !== o.to.y && (b = b.concat(c).concat(h),
                    ...
                    a.css(a.from), ("content" === m || "both" === m) && (u = u.concat(["marginTop", "marginBottom"]).concat(c),
            ...
            t.effects.effect.scale = function (e, i) {
                ...
                s.effect = "size",
                    s.queue = !1,
                    s.complete = i,
                    "effect" !== o && (s.origin = l || ["middle", "center"],
                        s.restore = !0),
                    ...
                    s.fade && ("show" === o && (s.from.opacity = 0,
                            s.to.opacity = 1),
                        "hide" === o && (s.from.opacity = 1,
                            s.to.opacity = 0)),
                    n.effect(s)
            },
                        ...
                        return o > r && (i = r,
                            ...
                            this.selectees.each(function () {
                                var i = t.data(this, "selectable-item"),
                                    h = !1;
                                i && i.element !== n.element[0] && ("touch" === s.tolerance ? h = !(i.left > r || o > i.right || i.top > l || a > i.bottom) : "fit" === s.tolerance && (h = i.left > o && r > i.right && i.top > a && l > i.bottom),
            ...
            t.widget("ui.slider", t.ui.mouse, {
                ...
                _refreshValue: function () {
                    ...
                    this.options.values && this.options.values.length ? this.handles.each(function (n) {
                        ...
                        "max" === a && "horizontal" === this.orientation && this.range[h ? "animate" : "css"]({
                            width: 100 - i + "%"
                        }, {
                            queue: !1,
                            duration: r.animate
                        ...
                        "max" === a && "vertical" === this.orientation && this.range[h ? "animate" : "css"]({
                            height: 100 - i + "%"
                        }, {
                            queue: !1,
                            duration: r.animate
                ...
                _handleEvents: {
                    keydown: function (e) {
                        ...
                        switch (o = this.options.step,
                            n = s = this.options.values && this.options.values.length ? this.values(a) : this.value(),
                            e.keyCode) {
                        case t.ui.keyCode.HOME:
                            s = this._valueMin();
                            break;
                ...
                _mouseCapture: function (e, i) {
                    ...
                    return this.reverting ? !1 : this.options.disabled || "static" === this.options.type ? !1 : (this._refreshItems(e),
                        ...
                        n && (!this.options.handle || i || (t(this.options.handle, n).find("*").addBack().each(function () {
                            ...
                            this._removeCurrentsFromItems(), !0) : !1)
                },
                    ...
                    if (e) {
                        if (t.ui.ddmanager && !this.options.dropBehaviour && t.ui.ddmanager.drop(this, e),
                            ...
                            var n = this,
                                ...
                                o = this.options.axis,
                                a = {};
                            o && "x" !== o || (a.left = s.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollLeft)),
                                o && "y" !== o || (a.top = s.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollTop)),
                                this.reverting = !0,
            ...
            t.widget("ui.tabs", {
                    ...
                    this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist").delegate("> li", "mousedown" + this.eventNamespace, function (e) {
                        ...
                        this.anchors.each(function (i, n) {
                            ...
                            e._isLocal(n) ? (s = n.hash,
                                    a = s.substring(1),
                                    o = e.element.find(e._sanitizeSelector(s))) : (a = l.attr("aria-controls") || t({}).uniqueId()[0].id,
                                    s = "#" + a,
                                    o = e.element.find(s),
                ...
                load: function (e, i) {
                    ...
                    this._isLocal(o[0]) || (this.xhr = t.ajax(this._ajaxSettings(o, i, r)),
                        this.xhr && "canceled" !== this.xhr.statusText && (s.addClass("ui-tabs-loading"),
            ...
            t.widget("ui.tooltip", {
                ...
                _open: function (e, i, n) {
                    ...
                    if (n) {
                        ...
                        i.is("[title]") && (e && "mouseover" === e.type ? i.attr("title", "") : i.removeAttr("title")),
                            ...
                            this.liveRegion.children().hide(),
                            n.clone ? (l = n.clone(),
                                l.removeAttr("id").find("[id]").removeAttr("id")) : l = n,
                ...
                close: function (e) {
                    ...
                    this.closing || (clearInterval(this.delayedShow),
                        ...
                        e && "mouseleave" === e.type && t.each(this.parents, function (e, n) {
    ...
    function (t) {
        ...
        function i(n, s) {
            var o = [],
                a = 0 == n.attributes.length,
                r = 0;
            if (n.tag.isComment)
                s.allowComments && (o.push("<!--"),
                    o.push(n.tag.rawAttributes),
                    o.push(">"),
                    s.format && e(n, s, o, r - 1));
            else {
                ...
                if (!n.isRoot && l && (o.push("<"),
                        ...
                        t.each(n.attributes, function () {
                            if (-1 == t.inArray(this.name, s.removeAttrs)) {
                                ...
                                "class" == this.name && s.allowedClasses.length > 0 && (i = t.grep(i.split(" "), function (e) {
                                    ...
                                    null != i && (i.length > 0 || t.inArray(this.name, n.tag.requiredAttributes) > -1) && (o.push(" "),
                                        o.push(this.name),
                                        o.push("="),
                                        o.push(a),
                                        o.push(i),
                    ...
                    if (!n.isRoot && l && o.push(">"),
                        ...
                        for (var p = [], m = 0; m < n.children.length; m++) {
                            var g = n.children[m],
                                v = t.htmlClean.trim(f(u(g) ? g : g.childrenToString()));
                            d(g) && m > 0 && v.length > 0 && (h(g) || c(n.children[m - 1])) && p.push(" "),
                                u(g) ? v.length > 0 && p.push(v) : (m != n.children.length - 1 || "br" != g.tag.name) && (s.format && e(g, s, p, r),
                                    p = p.concat(i(g, s)))
                        }
                        s.formatIndent--,
                            p.length > 0 && (s.format && "\n" != p[0] && e(n, s, o, r),
                                o = o.concat(p),
                                a = !1)
                    }!n.isRoot && l && (s.format && e(n, s, o, r - 1),
                        o.push("</"),
                        o.push(n.tag.name),
                        o.push(">"))
                }
        ...
        function a(t) {
            return t ? (this.tag = t,
                    this.isRoot = !1) : (this.tag = new l("root"),
                    this.isRoot = !0),
                this.attributes = [],
                this.children = [],
        ...
        function l(e, i, n, s) {
            return this.name = e.toLowerCase(),
                ...
                this.render = !0,
                this.init = function () {
                    if ("--" == this.name ? (this.isComment = !0,
                            this.isSelfClosing = !0,
                            this.format = !0) : (this.isComment = !1,
                            this.isSelfClosing = t.inArray(this.name, w) > -1,
                            this.isNonClosing = t.inArray(this.name, x) > -1,
                            this.isClosing = void 0 != i && i.length > 0,
                            this.isInline = t.inArray(this.name, m) > -1,
                            this.disallowNest = t.inArray(this.name, v) > -1,
                            this.requiredParent = y[t.inArray(this.name, y) + 1],
                            this.allowEmpty = s && t.inArray(this.name, s.allowEmpty) > -1,
                            this.toProtect = t.inArray(this.name, _) > -1,
                            this.format = t.inArray(this.name, g) > -1 || !this.isInline),
                        this.rawAttributes = n,
                        this.requiredAttributes = k[t.inArray(this.name, k) + 1],
                        s) {
                        if (s.tagAttributesCache || (s.tagAttributesCache = []), -1 == t.inArray(this.name, s.tagAttributesCache)) {
                            ...
                            s.tagAttributesCache.push(this.name),
                                s.tagAttributesCache.push(e)
                        }
        ...
        t.fn.htmlClean = function (e) {
            ...
            t.htmlClean = function (e, o) {
                o = t.extend({}, t.htmlClean.defaults, o),
                    o.allowEmpty = b.concat(o.allowEmpty);
                var h, c = /(<(\/)?(\w+:)?([\w]+)([^>]*)>)|<!--(.*?--)>/gi,
                    d = /([\w\-]+)\s*=\s*(".*?"|'.*?'|[^\s>\/]*)/gi,
                    p = new a,
                    f = [p],
                ...
                for (var g; h = c.exec(e);) {
                    var v = h[6] ? new l("--", null, h[6], o) : new l(h[4], h[2], h[5], o),
                        y = e.substring(g, h.index);
                    if (y.length > 0) {
                        ...
                        for (var w, x = new a(v); w = d.exec(v.rawAttributes);) {
                            if ("style" == w[1].toLowerCase() && o.replaceStyles)
                                for (var C = !v.isInline, k = 0; k < o.replaceStyles.length; k++)
                                    o.replaceStyles[k][0].test(w[2]) && (C || (v.render = !1,
                                            C = !0),
                                        m.children.push(x),
                                        f.push(x),
                                        m = x,
                                        v = new l(o.replaceStyles[k][1], "", "", o),
                                        x = new a(v));
                        ...
                        for (var D = 0; D < o.replace.length; D++)
                            for (var T = 0; T < o.replace[D][0].length; T++) {
                                ...
                                if (I && o.replace[D][0][T] == v.name || !I && o.replace[D][0][T].test(h)) {
                                    v.rename(o.replace[D][1]),
                                        D = o.replace.length;
                                    break
                                }
                            }
                        var S = !0;
                        if (m.isRoot || (m.tag.isInline && !v.isInline ? (S = s(f)) && (m = f[f.length - 1]) : m.tag.disallowNest && v.disallowNest && !v.requiredParent ? S = !1 : v.requiredParent && (S = n(f, v.requiredParent)) && (m = f[f.length - 1])),
                            S)
                            if (m.children.push(x),
                                v.toProtect)
                                for (var E; E = c.exec(e);) {
                                    var A = new l(E[4], E[1], E[5], o);
                                    if (A.isClosing && A.name == v.name) {
                                        x.children.push(RegExp.leftContext.substring(g)),
                                            g = c.lastIndex;
                                        break
                                    }
                                } else
                                v.isSelfClosing || v.isNonClosing || (f.push(x),
                                    m = x)
                    }
                }
        ...
        var m = ["a", "abbr", "acronym", "address", "b", "big", "br", "button", "caption", "cite", "code", "del", "em", "font", "hr", "i", "input", "img", "ins", "label", "legend", "map", "q", "s", "samp", "select", "option", "param", "small", "span", "strike", "strong", "sub", "sup", "tt", "u", "var"],
            g = ["address", "button", "caption", "code", "input", "label", "legend", "select", "option", "param"],
            v = ["h1", "h2", "h3", "h4", "h5", "h6", "p", "th", "td", "object"],
            b = ["th", "td"],
            y = [null, "li", ["ul", "ol"], "dt", ["dl"], "dd", ["dl"], "td", ["tr"], "th", ["tr"], "tr", ["table", "thead", "tbody", "tfoot"], "thead", ["table"], "tbody", ["table"], "tfoot", ["table"], "param", ["object"]],
            _ = ["script", "style", "pre", "code"],
            w = ["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"],
            x = ["!doctype", "?xml"],
            C = [["class"], "?xml", [], "!doctype", [], "a", ["accesskey", "class", "href", "name", "title", "rel", "rev", "type", "tabindex"], "abbr", ["class", "title"], "acronym", ["class", "title"], "blockquote", ["cite", "class"], "button", ["class", "disabled", "name", "type", "value"], "del", ["cite", "class", "datetime"], "form", ["accept", "action", "class", "enctype", "method", "name"], "iframe", ["class", "height", "name", "sandbox", "seamless", "src", "srcdoc", "width"], "input", ["accept", "accesskey", "alt", "checked", "class", "disabled", "ismap", "maxlength", "name", "size", "readonly", "src", "tabindex", "type", "usemap", "value"], "img", ["alt", "class", "height", "src", "width"], "ins", ["cite", "class", "datetime"], "label", ["accesskey", "class", "for"], "legend", ["accesskey", "class"], "link", ["href", "rel", "type"], "meta", ["content", "http-equiv", "name", "scheme", "charset"], "map", ["name"], "optgroup", ["class", "disabled", "label"], "option", ["class", "disabled", "label", "selected", "value"], "q", ["class", "cite"], "script", ["src", "type"], "select", ["class", "disabled", "multiple", "name", "size", "tabindex"], "style", ["type"], "table", ["class", "summary"], "th", ["class", "colspan", "rowspan"], "td", ["class", "colspan", "rowspan"], "textarea", ["accesskey", "class", "cols", "disabled", "name", "readonly", "rows", "tabindex"], "param", ["name", "value"], "embed", ["height", "src", "type", "width"]],
            k = [[], "img", ["alt"]],
            D = [" ", " ", "	", "\n", "\r", "\f"]
    }(jQuery),
    ...
    a.VERSION = "3.3.5",
        a.prototype.toggle = function (n) {
            ...
            if (!s.is(".disabled, :disabled")) {
                ...
                if (i(), !a) {
                    ...
                    if (o.trigger(n = t.Event("show.bs.dropdown", r)),
        ...
        a.prototype.keydown = function (i) {
            if (/(38|40|27|32)/.test(i.which) && !/input|textarea/i.test(i.target.tagName)) {
                var n = t(this);
                if (i.preventDefault(),
                    i.stopPropagation(), !n.is(".disabled, :disabled")) {
                    var s = e(n),
                        a = s.hasClass("open");
                    ...
                    if (l.length) {
                        ...
                        38 == i.which && h > 0 && h--,
                            40 == i.which && h < l.length - 1 && h++, ~h || (h = 0),
    ...
    i.VERSION = "3.3.5",
        ...
        i.prototype.show = function () {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                if (h) {
                    ...
                    r = "bottom" == r && c.bottom + d > f.bottom ? "top" : "top" == r && c.top - d < f.top ? "bottom" : "right" == r && c.right + u > f.width ? "left" : "left" == r && c.left - u < f.left ? "right" : r,
        ...
        i.prototype.hide = function (e) {
            ...
            return this.$element.trigger(a),
                a.isDefaultPrevented() ? void 0 : (o.removeClass("in"),
    ...
    i.VERSION = "3.3.5",
        ...
        i.prototype.show = function () {
            var e = this.element,
                ...
                n = e.data("target");
            if (n || (n = e.attr("href"),
                    n = n && n.replace(/.*(?=#[^\s]*$)/, "")), !e.parent("li").hasClass("active")) {
                ...
                if (s.trigger(o),
                    e.trigger(a), !a.isDefaultPrevented() && !o.isDefaultPrevented()) {
                    var r = t(n);
