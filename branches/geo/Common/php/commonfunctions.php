...
/*
 * rating and review relaetde functions
 */
function insert_user_rating($rate){
	$insert_data	  =   array(
			'Table'	=>	'inventory',
			'Fields'=>	$product
	);
...
function read_user_rating($rate){
	$insert_data	  =   array(
			'Table'	=>	'inventory',
			'Fields'=>	$product
	);
...
function insert_user_review($review){
	$update_data	  =   array(
			'Table'	=>	'inventory',
			'Fields'=>	$product,
			'clause'=>	"id=".$row_id_to_update." && owner=".$_SESSION['userid']
...
function read_user_review($review){
	$update_data	  =   array(
			'Table'	=>	'inventory',
			'Fields'=>	$product,
			'clause'=>	"id=".$row_id_to_update." && owner=".$_SESSION['userid']
...
function insert_product_rate($id_of_product_to_read){
	if($id_of_product_to_read	!=	null	&&	$id_of_product_to_read	!=	''	&&	is_int($id_of_product_to_read)){
		$read_object	= array(
				'Table'	=>	'inventory',
				'Fields'=>	'*',
...
function read_product_rate($id_of_product_to_read){
	if($id_of_product_to_read	!=	null	&&	$id_of_product_to_read	!=	''	&&	is_int($id_of_product_to_read)){
		$read_object	= array(
				'Table'	=>	'inventory',
				'Fields'=>	'*',
...
function insert_product_review($id_of_product_to_read){
	if($id_of_product_to_read	!=	null	&&	$id_of_product_to_read	!=	''	&&	is_int($id_of_product_to_read)){
		$read_object	= array(
				'Table'	=>	'inventory',
				'Fields'=>	'*',
...
function read_product_review($id_of_product_to_read){
	if($id_of_product_to_read	!=	null	&&	$id_of_product_to_read	!=	''	&&	is_int($id_of_product_to_read)){
		$read_object	= array(
				'Table'	=>	'inventory',
				'Fields'=>	'*',
